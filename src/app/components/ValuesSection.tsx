      ...
      <div className="grid grid-cols-1 items-center gap-8 sm:gap-12 lg:grid-cols-2">
        ...
        <Reveal delay={120}>
          <div className="relative mx-auto max-w-md">
            <div className="absolute inset-0 -z-10 scale-110 rounded-[2.5rem] bg-gradient-to-br from-rose-200/60 to-mauve/30 blur-2xl" />
            <div className="glass-card overflow-hidden p-10 text-center">
              <div className="absolute inset-0 -z-10 opacity-60" style={{ background: "radial-gradient(20rem 20rem at 50% 0%, rgba(238,174,186,0.4), transparent 60%)" }} />
              <Image
                src="/logo.png"
